...
const PaymentInstructions = () => (
  <div className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-5 text-left space-y-2 mt-2">
    ...
    <div className="flex justify-between text-sm">
      ...
      <span className="font-bold text-slate-800">KES 5,000</span>
    </div>
  </div>
);
        ...
        <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <ul className="space-y-3 text-sm">
              {[
                { label: 'Format',   value: '2-day webinar' },
                { label: 'Mode',     value: 'Online' },
                { label: 'Duration', value: '9:00 AM – 4:00 PM (both days)' },
                { label: 'Fee',      value: 'KES 5,000 per session' },
              ].map(({ label, value }) => (
